  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link" href="../nofuautocar/src/forms/user/mygarage.php">mygarage</a>
        </li>
...
<div id="carouselauto" class="carousel slide" style="padding-top: 100px;" data-bs-ride="carousel">
    <div class="carousel-inner">
        <?php
        $folder = '../nofuautocar/public/resource/carousels/'; // Folder that contains the images
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            if ($foto) {
              ...
              $src = '../nofuautocar/public/uploads/default.png'; // Placeholder image
          }
