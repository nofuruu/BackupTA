  ...
  <div class="container">
    <div class="login-card">
      ...
      <form id="loginForm" method="POST" action="../function/proses-login.php">
        ...
        <p class="text-center mt-3">Lupa Password? <a href="../function/proses_register.php" class="link">Rubah Password</a></p>
        <p class="text-center mt-3">Belum memiliki akun? <a href="../forms/register.php" class="link">Register</a></p>
